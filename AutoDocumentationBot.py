...
def tags_mes(message):
    ...
    "<b>ИС УП.11.01</b>\n" \
    "Аттестационный лист – <code>code_group: Код группы, student_name: ФИО студента, num_course: Номер курса, "
    "start_pract: Дата начала учебной практики, end_pract: Дата конца учебной практики, grade: Оценка</code>\n"
    "<b>ИС ПМ.02.01</b>\n"
    "Аттестационный лист – <code>student_name: ФИО студента, code_group: Код группы, num_course: Номер курса, "
    "place_pract: Адрес практики, start_pract: Дата начала производственной практики, end_pract: Дата конца производственной практики, grade: Оценка</code>\n" \
    "Дневник – <code>student_name: ФИО студента, num_course: Номер курса, code_group: Код группы, fio_ruk: ФИО руководителя практики от учебного заведения, "
    "place_pract: Адрес практики, start_pract: Дата начала производственной практики, end_pract: Дата конца производственной практики, grade: Оценка</code>\n" \
    "Характеристика – <code>student_name: ФИО студента, code_group: Код группы, start_pract: Дата начала производственной практики, "
    "end_pract: Дата конца производственной практики, base_pract: Название организации, в которой проходила практика, "
    "character_theory: Характер теоритической подготовки, character_work: Характер практической подготовки</code>\n"
    "<b>ИС ПМ.04.01</b>\n" \
    "Аттестационный лист – <code>student_name: ФИО студента, code_group: Код группы, num_course: Номер курса, "
    "place_pract: Адрес практики, start_pract: Дата начала производственной практики, end_pract: Дата конца производственной практики, grade: Оценка</code>\n" \
    "Дневник – <code>student_name: ФИО студента, num_course: Номер курса, code_group: Код группы, fio_ruk: ФИО руководителя практики от учебного заведения, "
    "place_pract: Адрес практики, start_pract: Дата начала производственной практики, end_pract: Дата конца производственной практики, grade: Оценка</code>\n" \
    "Характеристика – <code>student_name: ФИО студента, code_group: Код группы, start_pract: Дата начала производственной практики, "
    "end_pract: Дата конца производственной практики, base_pract: Название организации, в которой проходила практика</code>\n"
    "<b>ИС ПДП</b>\n" \
    "Аттестационный лист – <code>student_name: ФИО студента, code_group: Код группы, num_course: Номер курса, "
    "place_pract: Адрес практики, start_pract: Дата начала преддипломной практики, end_pract: Дата конца преддипломной практики, grade: Оценка</code>\n" \
    "Дневник – <code>student_name: ФИО студента, num_course: Номер курса, code_group: Код группы, fio_ruk: ФИО руководителя практики от учебного заведения, "
    "place_pract: Адрес практики, start_pract: Дата начала преддипломной практики, end_pract: Дата конца преддипломной практики, grade: Оценка</code>\n" \
    "Характеристика – <code>student_name: ФИО студента, code_group: Код группы, start_pract: Дата начала преддипломной практики, "
    "end_pract: Дата конца преддипломной практики, base_pract: Название организации, в которой проходила практика</code>\n" \
    "<b>Характеристика студента ОТЛ-ХОР</b> – <code>num_course: Номер курса, code_group: Код группы, name_spec: Наименование специальности, student_name: ФИО студенты, " \
    "date_birth: Дата рождения студента, address_student: Адрес проживания студента, fn_student: Имя студента, " \
    "date_enroll: Дата поступления на специальность, date: Дата заполнения</code>\n" \
    "<b>Экзаменационная ведомость до 26 человек</b> – <code>name_dis: Наименование дисциплины, num_course: Номер курса, " \
    "code_group: Код группы, name_group: Наименование группы, sn1-sn26: ФИО студента, date: Дата проведения экзамена</code>", parse_mode='HTML')
